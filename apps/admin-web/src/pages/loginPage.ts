  ...
  root.innerHTML = `
    <div class="re-auth-shell">
      <section class="re-brand-panel re-animate-fade">
        ...
        <p class="re-tagline mb-0">Admin console — restaurant & platform management.</p>
      </section>
      <section class="re-form-panel">
        <div class="re-form-card re-animate-slide-up">
          <h1 class="h3 mb-1">Sign in</h1>
          <p class="re-muted mb-4">Restaurant owner and platform admin access only.</p>
          ...
          <p class="re-muted mt-4 mb-0 small">
            Accounts are provisioned by a platform admin — there's no self-registration here.
          </p>
        </div>
      </section>
    </div>
