  ...
  root.innerHTML = `
    <div class="re-auth-shell">
      <section class="re-brand-panel re-animate-fade">
        ...
        <p class="re-tagline mb-0">Good food, close to home — from restaurants across your city.</p>
      </section>
      <section class="re-form-panel">
        <div class="re-form-card re-animate-slide-up">
          <h1 class="h3 mb-1">Welcome back</h1>
          <p class="re-muted mb-4">Sign in to order, track deliveries, and book a table.</p>
          ...
          <form id="login-form" novalidate>
            ...
            <button type="submit" class="btn-re-primary w-100" id="login-submit">
              Sign in
            </button>
          </form>
          ...
          <p class="re-muted mt-4 mb-0">
            New to Richy's Eat? <a href="/register" data-link style="color:var(--re-primary); font-weight:600;">Create an account</a>
          </p>
        </div>
      </section>
    </div>
